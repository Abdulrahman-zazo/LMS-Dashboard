      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className={`ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 ${
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      ...
      className={cn(
        `flex flex-col gap-2 text-center sm:${
